...
export const athletesApi = {
  ...
  create: (data: unknown) => apiClient.post('/athletes', data).then((r) => r.data),
  ...
  getUpcoming: (id: string) => apiClient.get(`/athletes/${id}/upcoming`).then((r) => r.data),
  ...
  bindCoach: (athleteProfileId: string) =>
